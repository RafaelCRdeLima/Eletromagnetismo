...
\small
Onde \(q\) é a carga elétrica, \(\epsilon_0\) é a permissividade do vácuo,
\(\alpha\) é a constante de estrutura fina, \(r\) é a distância ao ponto de
carga, e \(\lambda_c\) é o comprimento de Compton da partícula.
